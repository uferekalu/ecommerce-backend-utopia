...
exports.handler = async (event, context) => {
  try {
    ...
    const created_token = await token.create_token(result.insertId)
    ...
    await db.insert_new(token_data, "user_tokens")
    ...
    return handler.returner(
      [true, { message: "Created account successful", id_user: result.insertId }],
      api_name,
      201
    )
  } catch (e) {
